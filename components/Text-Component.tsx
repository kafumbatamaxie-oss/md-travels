...
export default function TextComponent({title, desc1, desc2} : TextComponentProps) {
  return (
        ...
        <div className="max-w-3xl bg-transparent">
            ...
            <p className="mt-6 text-base sm:text-lg leading-relaxed text-sky-800 max-w-prose">
                {desc1}
            </p>

            {desc2 && <p className="mt-4 text-sm sm:text-base leading-relaxed text-sky-800 max-w-prose">
            {desc2}
            </p>}
        </div>
