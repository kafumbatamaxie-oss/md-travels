...
export async function generateCorollaInvoicePDF(data: any) {
  const HALF_DAY = 1800;
  const FULL_DAY = 3600;

  const rate = data.days === 0.5 ? HALF_DAY : FULL_DAY;
  const total =
    data.days === 0.5 ? HALF_DAY : FULL_DAY * data.days;
  ...
  const rows = [
    {
      ...
      no: "1",
      vehicle: "Toyota Corolla (4 Seater)",
      destination:
        data.days === 0.5
          ? "Half Day Rental"
          : `${data.days} Day Rental`,
      rate: total,
    },
  ];
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.metaSection}>
          <View style={styles.clientBox}>
            ...
            <Text>Toyota Corolla 4 Seater Rental</Text>
            ...
            <Text>
              Dropoff: {data.dropoffDate} {data.dropoffTime}
            </Text>
          </View>
          ...
          <View style={styles.bankBox}>
            ...
            <Text>
              Bank Name: DLUNGE TRANSPORT SERVICE
            </Text>
        ...
        <View style={styles.terms}>
          ...
          <Text>
            • Booking confirmed upon deposit payment.
          </Text>

          <Text>
            • Balance payable before travel date.
          </Text>

          <Text>
            • Driver included in all bookings.
          </Text>

          <Text>
            • Passenger belongings remain
            responsibility.
          </Text>

          <Text>
            • Services governed by South African
            law.
          </Text>
        </View>
