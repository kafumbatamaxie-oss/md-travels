        ...
        <div className="md:px-10 mx-auto">
          <div className="grid md:grid-cols-6 gap-8 md:gap-12 items-start">
            ...
            <div className="md:col-span-2">
              <p className="text-secondary text-sm md:text-base font-semibold mb-2 uppercase tracking-wider">
                Ready to go?
              </p>
              <h1 className="text-4xl text-sky-950  md:text-5xl lg:text-6xl font-bold mb-4 text-balance">Request A Quote Now</h1>
            </div>

            {/* Right: Form */}
            <div className="bg-card border md:col-span-4 border-border rounded-xl p-6 md:p-8 shadow-lg">
              {/* Progress Bar */}
              {/* Progress Bar */}
              <div className="mb-6">
                <p className="text-sm md:text-md text-sky-950 mb-2">
                ...
                <div className="relative">
                  ...
                  {/* Percentage inside gold section */}
                  <span
                    className="absolute left-0 top-0 h-full flex items-center justify-center text-xs font-semibold text-white pointer-events-none"
              ...
              {success && (
                <div className="mb-6 p-4 bg-green-500/10 border border-green-500/50 rounded-lg flex items-center gap-3">
                  ...
                  <span className="text-green-600 text-sm">Quote request sent! We'll contact you soon.</span>
                </div>
              )}
              ...
              {step === 1 && (
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="w-full px-8 py-4 bg-sky-950 hover:opacity-90 text-white rounded-lg font-bold uppercase tracking-wider transition-all text-sm shadow-lg"
                  >
                    Next Step
                  </button>
                </form>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <div className="flex gap-4">
                    <button
                      ...
                      className="px-6 py-4 bg-muted hover:bg-muted/80 text-foreground rounded-lg font-bold uppercase tracking-wider transition-all text-sm shadow-lg flex items-center gap-2"
                    >
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="flex-1 px-8 py-4 bg-secondary hover:opacity-90 text-white rounded-lg font-bold uppercase tracking-wider transition-all text-sm shadow-lg flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                      {loading ? (
                        "Sending..."
                      ) : (
